...
class FaceTrackerReconfigure:
    def __init__(self, root, face_tracker_pipeline):
        ...
        self.max_num_faces_slider = tk.Scale(self._root, from_=1, to=4, orient=tk.HORIZONTAL, command=self.update_max_num_faces)
        self.max_num_faces_slider.set(self._face_tracker_pipeline.max_num_faces)
        self.max_num_faces_slider.pack(anchor=tk.W)
        ...
        self.min_detection_confidence_slider.set(self._face_tracker_pipeline.min_detection_confidence)
        ...
        self.min_tracking_confidence_slider.set(self._face_tracker_pipeline.min_tracking_confidence)
