...
class BodyTrackerReconfigure:
    def __init__(self, root, body_tracker_pipeline):
        ...
        self.model_complexity_slider = tk.Scale(
            self._root,
            from_=0,
            to=2,
        ...
        self.model_complexity_slider.pack(anchor=tk.W, padx=5, pady=5, fill=tk.X)
        ...
        self.min_detection_confidence_slider.set(
            self._body_tracker_pipeline.min_detection_confidence
        )
        ...
        self.min_tracking_confidence_slider.set(
            self._body_tracker_pipeline.min_tracking_confidence
        )
