...
class HandTrackerReconfigure:
    def __init__(self, root, hand_tracker_pipeline):
        ...
        self.max_hands_slider = tk.Scale(self._root, from_=1, to=4, orient=tk.HORIZONTAL, command=self.update_max_num_hands)
        self.max_hands_slider.set(self._hand_tracker_pipeline.max_num_hands)
        self.max_hands_slider.pack(anchor=tk.W)
        ...
        self.min_detection_confidence_slider.set(self._hand_tracker_pipeline.min_detection_confidence)
        ...
        self.min_tracking_confidence_slider.set(self._hand_tracker_pipeline.min_tracking_confidence)
